 ...
 * @author senti
 */
public class ChallengeGameLose extends javax.swing.JDialog {
    public Frame parent;
    /**
     * Creates new form ChallengeGameLose
     */
    public ChallengeGameLose(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.parent = parent;
        setLocation(285,111);
        initComponents();
    ...
    private void btnStart2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStart2ActionPerformed
        // TODO add your handling code here:
        ChallengeGameMode1 classic = new ChallengeGameMode1(parent,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChallengeGameLose.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChallengeGameLose dialog = new ChallengeGameLose(new javax.swing.JFrame(), true);
