 ...
 * @author senti
 */
public class AreUSureMultiplayer extends javax.swing.JDialog {
    public MultiplayerGameMode m;
    public Frame parent;
    /**
     * Creates new form AreUSureMultiplayer
     */
    public AreUSureMultiplayer(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.parent = parent;
        setLocation(483,262);
    ...
    public AreUSureMultiplayer(java.awt.Frame parent, boolean modal,MultiplayerGameMode m){
        this(parent,modal);
        this.m = m;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AreUSureMultiplayer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AreUSureMultiplayer dialog = new AreUSureMultiplayer(new javax.swing.JFrame(), true);
